...
public class OurCompilerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WHILE", "RETURN", "PLUS", "MINUS", "TIMES", "DIVIDED", "MODULO", "LESS", 
			"GREAT", "EQ", "NEQ", "LESSOREQ", "GREATOREQ", "AND", "OR", "NOT", "ATR", 
			"ATRPLUS", "ATRMINUS", "ATRTIMES", "ATRDIVIDED", "ATRMODULO", "INCREMENT", 
			"DECREMENT", "LPAR", "RPAR", "LGROUP", "RGROUP", "EOL", "COMMA"
		};
	}
	...
	public OurCompilerLexer(CharStream input) {
		super(input);
